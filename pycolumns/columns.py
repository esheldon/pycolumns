...
def where(query_index):
    ...
    ----------
    query_index: Indices
        An Indices object generated by using operators such as "==" on an indexed
        column object.  The Column methods between and match also return Indices
        objects.  Indices objects can be combined with the "|" and "&" operators.
