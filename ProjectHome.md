A simple, efficient column-oriented, pythonic database.  Data are input and output as numerical python arrays, and indexing is provided by berkeley db through the numpydb package.

Currently this package depends on [esutil](http://code.google.com/p/esutil/) and optionally [numpydb](http://code.google.com/p/numpydb/) for indexing.  A TODO is to examine copying the needed parts into pycolumns.
